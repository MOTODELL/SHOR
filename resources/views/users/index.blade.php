	...
	<div class="card card-table">
		<div class="card-header">
			...
			<a class="btn btn-rounded btn-space btn-primary" href="{{ route('users.create') }}">
					<i class="icon zmdi zmdi-account-add icon-left"></i>
					Nuevo
				</a>
			</div>
			...
			<table class="table table-striped table-hover table-fw-widget dataTable">
				...
				@foreach ($users as $user)
					<tr class="success done">
						...
						<td class="text-right">
							<a href="{{ route('users.edit', $user->id) }}" class="btn btn-warning" data-toggle="tooltip" data-placement="left" title="Editar"><i class="mdi mdi-lead-pencil mdi-18px"></i></a>
