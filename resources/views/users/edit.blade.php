            ...
            <form method="POST" action="{{ route('users.update', $user) }}">
                ...
                <div class="form-row mt-4">
                    ...
                    <div id="selectDependency" class="form-group col-sm-12 col-md-6 col-lg-4">
                        <label for="dependency">{{ __('Área médica') }}</label>
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-4">
                        ...
                        <input id="username" type="text" class="form-control form-control-lg text-lowercase @error('username') is-invalid @enderror" name="username" value="{{ $user->username }}" required autocomplete="username" placeholder="example123">
