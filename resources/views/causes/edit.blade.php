            ...
            <form method="POST" action="{{ route('causes.update', $cause) }}">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        <input id="code" type="text" class="form-control @error('code') is-invalid @enderror" placeholder="Urgencias" name="code" value="{{ $cause->code }}" required autocomplete="code" autofocus>
                        @error('code')
                    ...
                    <div class="form-group col-sm-12 col-md-6">
                        ...
                        <input id="description" type="text" class="form-control @error('description') is-invalid @enderror" placeholder="Urgencias" name="description" value="{{ $cause->description }}" required autocomplete="description" autofocus>
                        @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
