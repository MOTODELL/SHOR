            ...
            <form method="POST" action="{{ route('doctors.update', $doctor) }}">
                ...
                <div class="form-row mt-4">
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-4">
                        ...
                        <input id="lastname" type="text" class="form-control form-control-lg @error('lastname') is-invalid @enderror" placeholder="Apellido" name="lastname" value="{{ $doctor->lastname }}" required autocomplete="lastname">
                        @error('lastname')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group col-sm-12 col-md-6 col-lg-4">
                        ...
                        <input id="phone" type="phone" class="form-control form-control-lg @error('phone') is-invalid @enderror" name="phone" value="{{ $doctor->phone }}" required autocomplete="phone" placeholder="322000000">
                        @error('phone')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
