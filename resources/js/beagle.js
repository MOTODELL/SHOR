...
var App = (function() {
    ...
    var e,
        ...
        v = {
            ...
            collapsibleSidebarCollapsedClass:
    ...
    function x(e) {
        if (void 0 !== e[0])
            return new PerfectScrollbar(e[0], { wheelPropagation: !1 });
    }
    function A() {
        $(".be-scroller", n);
        ...
        n.length > 0 &&
            ($(".be-toggle-right-sidebar").on("click", function(t) {
                s && e.hasClass(v.openRightSidebarClass)
                    ? a()
                    : s ||
                      (e.addClass(
                          v.openRightSidebarClass + " " + v.transitionClass
                      ),
                      (s = !0)),
                    t.preventDefault();
            }),
            $(document).on("mousedown touchstart", function(t) {
                !$(t.target).closest(n).length &&
                    e.hasClass(v.openRightSidebarClass) &&
                    (v.closeRsOnClickOutside || $.isSm()) &&
                    a();
            })),
    ...
    function _() {
        ...
        function c(e, t) {
            ...
            "" != e &&
                ($('<div class="msg">' + e + "</div>").appendTo(i),
                i.appendTo(n),
                a
                    .stop()
                    .animate(
        ...
        $(".user a", t).on("click", function(t) {
            e.hasClass("chat-opened") ||
                (e.addClass("chat-opened"),
    ...
    return {
        ...
        init: function(E) {
                          ...
                          s && b($("> ul", s), i),
                              !$.isSm() && m() && l
                                  ? (n.addClass("open"),
                                    a.addClass("visible"),
                                    void 0 !== p && S(p),
                                    (void 0 !== p && p && p.nodeName) ||
                                        (p = x(n.find(".be-scroller"))),
                                    $(window).resize(function() {
                                        P(
                                            function() {
                                                $.isXs() ||
                      ...
                      t.hasClass(v.collapsibleSidebarClass) &&
                          ...
                          t.hasClass(v.collapsibleSidebarCollapsedClass)
                              ...
                              : $("li.active", o)
                                    .parents(".parent")
                                    .addClass("active open"),
                          i.find(".container-fluid > .navbar-collapse")
                              .length &&
                              o.length &&
                              (t
                                  .addClass(v.offCanvasLeftSidebarClass)
                                  .addClass(v.offCanvasLeftSidebarMobileClass),
                          ...
                          t.hasClass(v.offCanvasLeftSidebarClass) &&
                              (l.on("click", function(t) {
                                  s && e.hasClass(v.openLeftSidebarClass)
                                      ? (e.removeClass(v.openLeftSidebarClass),
                                        T())
                                      : (e.addClass(
                                            v.openLeftSidebarClass +
                                                " " +
                                                v.transitionClass
                                        ),
                                        (s = !0)),
                              ...
                              $(document).on("mousedown touchstart", function(
                                  ...
                                  $(t.target).closest(o).length ||
                                      $(t.target).closest(l).length ||
                                      !e.hasClass(v.openLeftSidebarClass) ||
                                      (e.removeClass(v.openLeftSidebarClass),
                                      T());
                              }));
                  })()
            ...
            a.length &&
                ...
                (b = x(a)),
                $(window).resize(function() {
                    $.isSm() && !t.hasClass(v.offCanvasLeftSidebarClass)
                        ? S(b)
                        : L.hasClass("ps")
                        ? C(b)
                        : (void 0 !== b && b && b.nodeName) || (b = x(a));
                })),
            r.length && M(),
                ...
                new MutationObserver(function(e, t) {
                    e.forEach(function(e) {
                        "attributes" == e.type &&
                            ...
                            (document.body.className.indexOf("swal2-shown") > 0
                                ? i.css({
                                      marginLeft:
                                          "calc(-" +
        ...
        activeItemLeftSidebar: function(e) {
            var t = $(e).parent(),
                i = $(t).parents("li");
            t.hasClass("active") ||
                ($("li.active", o).removeClass("active"),
                $(i).addClass("active"),
                $(t).addClass("active"));
        }
    };
...
(FastClick.prototype.needsClick = function(e) {
                    ...
                    _ ||
                        ((_ = new (function(t, T) {
                            ...
                            function Z(e, t) {
                                ...
                                return (
                                    (i.start.x = i.last.x = i.end.x =
                                        t.pageX || t.clientX),
                                    (i.start.y = i.last.y = i.end.y =
                                        t.pageY || t.clientY),
                                    (xe[e] = i),
                                    i
                                );
    ...
    (function(e) {
        ...
        function f(e) {
            ...
            return [
                t(e),
                t({ h: (o + 120) % 360, s: i.s, l: i.l }),
                t({ h: (o + 240) % 360, s: i.s, l: i.l })
            ];
        }
        function g(e) {
            var i = t(e).toHsl(),
            ...
            return [
                t(e),
                t({ h: (o + 90) % 360, s: i.s, l: i.l }),
                t({ h: (o + 180) % 360, s: i.s, l: i.l }),
        ...
        function m(e) {
            ...
            return [
                t(e),
                t({ h: (o + 72) % 360, s: i.s, l: i.l }),
                t({ h: (o + 216) % 360, s: i.s, l: i.l })
            ];
        }
        function b(e, i, o) {
            (i = i || 6), (o = o || 30);
        ...
        function v(e, i) {
            ...
            for (
                ...
                l.push(t({ h: n, s: a, v: r })), (r = (r + s) % 1);
            return l;
        }
        function w(e) {
            return (
                (e = parseFloat(e)), (isNaN(e) || 0 > e || e > 1) && (e = 1), e
            );
        }
        function k(t, i) {
            var o;
        ...
        (t.prototype = {
                ...
                return (
                    ...
                    0.2126 *
                        ...
                        0.7152 *
                            (0.03928 >= i
                                ? i / 12.92
                                : e.pow((i + 0.055) / 1.055, 2.4)) +
                        0.0722 *
                            (0.03928 >= o
                                ? o / 12.92
                                : e.pow((o + 0.055) / 1.055, 2.4))
                );
            },
            setAlpha: function(e) {
                return (
            ...
            toName: function() {
                return 0 === this._a
                    ? "transparent"
                    : !(this._a < 1) &&
                          (N[n(this._r, this._g, this._b, !0)] || !1);
            },
            toFilter: function(e) {
            ...
            (t.isReadable = function(e, i, o) {
                ...
                switch (
                    ...
                    "AA" !==
                        (l = (
                            (r = (r = o) || { level: "AA", size: "small" })
                                .level || "AA"
                        ).toUpperCase()) &&
                        "AAA" !== l &&
                        (l = "AA"),
                    "small" !== (s = (r.size || "small").toLowerCase()) &&
                        "large" !== s &&
                        (s = "small"),
            ...
            (t.mostReadable = function(e, i, o) {
                ...
                for (var d = 0; d < i.length; d++)
                    (n = t.readability(e, i[d])) > c &&
                        ((c = n), (s = t(i[d])));
                return t.isReadable(e, s, { level: r, size: l }) || !a
                    ? s
                    : ((o.includeFallbackColors = !1),
    ...
    (function(e) {
        var t = function(t) {
            var i, o;
            return (
                (o = (i = e("<div/>", { class: t }).appendTo("body")).is(
                    ":visible"
                )),
                i.remove(),
                o
        ...
        return (
            (App.ChartJs = function() {
                ...
                (e = tinycolor(App.color.primary)),
                        ...
                        datasets: [
                            {
                                ...
                                backgroundColor: e.setAlpha(0.8).toString(),
                                data: [A(), A(), A(), A(), A(), A(), A()]
                            },
                            {
                                label: "My Second dataset",
                                borderColor: t.toString(),
                                backgroundColor: t.setAlpha(0.5).toString(),
                                data: [A(), A(), A(), A(), A(), A(), A()]
                            }
                        ]
                    }),
                        ...
                        datasets: [
                            {
                                ...
                                backgroundColor: n.setAlpha(0.8).toString(),
                                data: [A(), A(), A(), A(), A(), A(), A()]
                            },
                            {
                                label: "Debit",
                                borderColor: a.toString(),
                                backgroundColor: a.setAlpha(0.5).toString(),
                                data: [A(), A(), A(), A(), A(), A(), A()]
                            }
                        ]
                    }),
                    ...
                    (v = App.color.primary),
                    (w = tinycolor(App.color.primary)
                        .lighten(12)
                        .toString()),
                    (k = tinycolor(App.color.primary)
                        .lighten(22)
                        .toString()),
                    ...
                    (C = App.color.success),
                    ($ = tinycolor(App.color.success)
                        .lighten(12)
                        .toString()),
                    (S = tinycolor(App.color.success)
                        .lighten(22)
                        .toString()),
        ...
        return (
            (App.chartsMorris = function() {
                ...
                (e = App.color.primary),
                    ...
                    (i = tinycolor(App.color.success)
                        .lighten(15)
                        .toString()),
                    (o = tinycolor(App.color.success)
                        .brighten(3)
                        .toString()),
                    Morris.Bar({
                        element: "bar-chart",
        ...
        return (
            (App.chartsSparklines = function() {
                ...
                ($.fn.sparkline.defaults.common.lineColor = e),
                    ($.fn.sparkline.defaults.common.fillColor = n
                        .setAlpha(0.3)
                        .toString()),
                    ...
                    ($.fn.sparkline.defaults.bullet.rangeColors[0] = a
                        .setAlpha(0.2)
                        .toString()),
                    ($.fn.sparkline.defaults.bullet.rangeColors[1] = a
                        .setAlpha(0.5)
                        .toString()),
                    ($.fn.sparkline.defaults.bullet.rangeColors[2] = a
                        .setAlpha(0.45)
                        .toString()),
                    ...
                    ($.fn.sparkline.defaults.box.boxFillColor = a
                        .setAlpha(0.5)
                        .toString()),
                    ...
                    $(".linecustom").sparkline("html", {
                        ...
                        width: "8em",
                        lineColor: i,
                        fillColor: r.setAlpha(0.4).toString(),
                        minSpotColor: !1,
                        maxSpotColor: !1,
                        spotColor: o,
                        spotRadius: 3
        ...
        return (
            (App.charts = function() {
                ...
                (i = tinycolor(App.color.primary)
                    ...
                    $.plot(
                        ...
                        ],
                        {
                            ...
                            tooltip: {
                                ...
                                content:
                                    "<div class='content-chart'> <span> %s </span> <div class='label'> <div class='label-x'> %x.0 </div> - <div class='label-y'> %y.0 </div> </div></div>",
                                defaultTheme: !1
                            },
                            colors: [i],
                    ...
                    $.plot(
                        ...
                        ],
                        {
                            ...
                            tooltip: {
                                ...
                                cssClass: "tooltip-chart",
                                content:
                                    "<div class='content-chart'> <div class='label'> <div class='label-x'> %x.0 </div> - <div class='label-y'> %y.0 </div> </div></div>",
                                defaultTheme: !1
                            },
                            colors: [a],
                            xaxis: { ticks: 11, tickDecimals: 0 },
                    ...
                    t("line-chart1", 45),
                    (r = tinycolor(App.color.danger)
                        .brighten(9)
                        .toString()),
                    (l = tinycolor(App.color.danger)
                        .lighten(13)
                        .toString()),
                    (s = tinycolor(App.color.danger)
                        .lighten(20)
                        .toString()),
                    (c = tinycolor(App.color.danger)
                        .lighten(27)
                    ...
                    $.plot(
                        ...
                        ],
                        {
                            ...
                            tooltip: {
                                ...
                                cssClass: "tooltip-chart",
                                content:
                                    "<div class='content-chart arrow-none'> <div class='label'> <div class='label-x'> %x.0% </div> </div></div>",
                                defaultTheme: !1
                            },
                            colors: [r, l, s, c],
                            legend: { show: !1 }
                    ...
                    (d = tinycolor(App.color.warning)
                        .lighten(25)
                        .toString()),
                    (u = tinycolor(App.color.warning)
                        .brighten(3)
                        .toString()),
                    $.plot(
                        $("#bar-chart1"),
                    ...
                    (function() {
                        ...
                        function n() {
                            for (
                                i.length > 0 && (i = i.slice(1));
                                i.length < o;

                            ) {
                                var e =
                                    (i.length > 0 ? i[i.length - 1] : 50) +
                                    10 * Math.random() -
                                    5;
                                e < 0 ? (e = 0) : e > 100 && (e = 100),
                                    i.push(e);
        ...
        return (
            (App.dashboard = function() {
                ...
                $('[data-toggle="counter"]').each(function(e, t) {
                    ...
                    (a = App.color.primary),
                    (r = tinycolor(App.color.primary)
                        .lighten(13)
                        .toString()),
                    (l = tinycolor(App.color.primary)
                        .lighten(20)
                        .toString()),
                    $.plot(
                        $("#main-chart"),
                    ...
                    void 0 !== jQuery.ui &&
                        u.datepicker({
                            ...
                            afterShow: function(e) {
                                ...
                                (t = e.dpDiv),
                                    6 == $("tbody tr", t).length
                                        ? t.addClass("ui-datepicker-6rows")
                                        : t.removeClass("ui-datepicker-6rows");
                            }
                        }),
                    (m = tinycolor(App.color.primary)
                        .lighten(15)
                        .toHexString()),
    ...
    (App = (function() {
        ...
        return (
            (App.masks = function() {
                ...
                $("[data-mask='kinship']").mask("9"),
                $("[data-mask='zip-code']").mask("99999"),
                $("[data-mask='ssn']").mask("99999999999"),
                    ...
                    o.on("keyup", function() {
                        ...
                        if (
                            ...
                            $.each(r, function(e, t) {
                                $(t.element)
                                    .parents(".col-sm-6")
                                    .addClass("icon-visible");
                            }),
                                t.addClass("hide-icons"),
                                i
                                    .not(o)
                                    .hide()
                                    .addClass("icon-category--hide-icons");
    ...
    (App = (function() {
        ...
        return (
            (App.megaMenu = function() {
                ...
                $(
                    ".be-sub-header .nav-link, .be-sub-header .dropdown-item",
                    e
                ).on("click", function(e) {
                    var i = $(this),
                        o = i.parent(),
                        ...
                        o(
                            function() {
                                ...
                                $.isSm() ||
                                    ...
                                    t.filter(":first-child").addClass("open");
                            },
                            100,
                            "sync_tabs"
                        );
                ...
                $("#external-events .fc-event").each(function() {
                    ...
                    $("#calendar").fullCalendar({
                        header: {
                            ...
                            center: "",
                            right:
                                "month,agendaWeek,agendaDay, today, prev,next"
                        },
            ...
            (App.tableFilters = function() {
                $(".select2").select2({ width: "100%" }),
                    ...
                    $.fn.dataTable.ext.search.push(function(e, t, i, o, n) {
                        var a = $("#milestone_slider")
                                .val()
                                .split(","),
                            r = $(e.aoData[i].anCells[3])
                                .data("progress")
                                .split(","),
                            l = $(".select2").val(),
                            ...
                            d =
                                "" !== $("#dateTo").val()
                                    ...
                                    : new Date("01/01/2099"),
                            u = new Date(
                                $(".date", e.aoData[i].anCells[5]).html()
                            ),
                            p = $("#toDo").is(":checked"),
                ...
                var e = $("#table1").DataTable({
                    pageLength: 5,
                    dom:
                        "<'row be-datatable-body'<'col-sm-12'tr>><'row be-datatable-footer'<'col-sm-5'i><'col-sm-7'p>>"
                });
                $("#milestone_slider")
                    .slider()
                    .on("slide", function(t) {
                    ...
                    $("#toDo, #inProgress, #inReview, #done").on(
                        "click",
                        function() {
                            e.draw();
                        }
            ...
            (App.dataTables = function() {
                ($.fn.DataTable.ext.pager.numbers_length = 4),
                    ...
                    $("#table3").dataTable({
                        ...
                        dom:
                            "<'row be-datatable-header'<'col-sm-6'l><'col-sm-6 text-right'B>><'row be-datatable-body'<'col-sm-12'tr>><'row be-datatable-footer'<'col-sm-5'i><'col-sm-7'p>>"
                    }),
                ...
                $("#not-basic").click(function() {
                    return (
                        $.gritter.add({
                            ...
                            text:
                                "You have a new Thomas message, let's checkout your inbox.",
                            image:
                                App.conf.assetsPath +
                                "/" +
                                App.conf.imgPath +
                    ...
                    $("#not-theme").click(function() {
                        return (
                            $.gritter.add({
                                title: "Welcome home!",
                                text:
                                    "You can start your day checking the new messages.",
                                image:
                                    App.conf.assetsPath +
                                    "/" +
                                    App.conf.imgPath +
                    ...
                    $("#not-sticky").click(function() {
                        return (
                            $.gritter.add({
                                title: "Sticky Note",
                                text:
                                    "Your daily goal is 130 new code lines, don't forget to update your work.",
                                image:
                                    App.conf.assetsPath +
                                    "/" +
                                    App.conf.imgPath +
                    ...
                    $("#not-text").click(function() {
                        return (
                            $.gritter.add({
                                title: "Just Text",
                                text:
                                    "This is a simple Gritter Notification. Etiam efficitur efficitur nisl eu dictum, nullam non orci elementum.",
                                class_name: "clean",
                                time: ""
                            }),
                            !1
                    ...
                    $("#not-dribbble").click(function() {
                        return (
                            $.gritter.add({
                                ...
                                text:
                                    "You can start your day checking the new comments.",
                                image:
                                    App.conf.assetsPath +
                                    "/" +
                                    App.conf.imgPath +
                    ...
                    $("#swal-success").click(function() {
                        return (
                            Swal.fire({
                                ...
                                text:
                                    "This is a sweetalert with custom background",
                                confirmButtonText: "Proceed",
                                showCloseButton: !0,
                                showCancelButton: !0,
                                customClass:
                    ...
                    $("#swal-col-success").click(function() {
                        return (
                            Swal.fire({
                                ...
                                text:
                                    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce ultrices euismod lobortis. Donec fermentum mattis velit id pretium. Suspendisse sed tortor sed diam lobortis tempus at sed lacus. Phasellus semper ex auctor libero scelerisque ultricies.",
                                confirmButtonText: "Proceed",
                                confirmButtonClass: "btn btn-success",
                                showCloseButton: !0,
                                showCancelButton: !0,
                                customClass:
                                    "colored-header colored-header-success"
                            }),
                            !1
                        );
                    }),
                    $("#swal-col-primary").click(function() {
                        return (
                            Swal.fire({
                                ...
                                showCancelButton: !0,
                                customClass:
                                    "colored-header colored-header-primary"
                            }),
                            !1
                        );
                    }),
                    $("#swal-col-warning").click(function() {
                        return (
                            Swal.fire({
                                ...
                                showCancelButton: !0,
                                customClass:
                                    "colored-header colored-header-warning"
                            }),
                            !1
                        );
                    }),
                    $("#swal-col-danger").click(function() {
                        return (
                            Swal.fire({
                                ...
                                showCancelButton: !0,
                                customClass:
                                    "colored-header colored-header-danger"
                            }),
                            !1
                        );
                    }),
                    $("#swal-col-dark").click(function() {
                        return (
                            Swal.fire({
                                ...
                                showCancelButton: !0,
                                customClass:
                                    "colored-header colored-header-dark"
                            }),
                            !1
                        );
                    }),
                    ...
                    $("#swal-queue").click(function() {
                        return (
                            Swal.mixin({
                                ...
                                showCancelButton: !0,
                                customClass:
                                    "content-header-center content-header-title-left content-actions-left",
                                progressSteps: ["1", "2", "3"]
                            })
                                .queue([
                                    "Question 1",
                    ...
                    $("#swal-radio").click(function() {
                        return (
                            Swal.fire({
                                ...
                                inputValidator: function(e) {
                                    return (
                                        !e && "You need to choose something!"
                                    );
                                }
                            }),
                            !1
